...
1. [Download the latest `.dmg`](/Grainulator-0.6.1.dmg) and open it, or build from source:
   ```bash
   git clone <repo-url>
   cd Grainulator
   swift build
...
- **DaisyDrums** — 5 percussive engines with a 4-lane × 16-step drum sequencer, **8-pattern bank**, and **pattern sequencer** for chaining patterns (DRUMS tab)
